...
@section('content')
    <div class="container-sm mt-5">
        <form action="{{ route('beverages.update', ['beverage' => $beverage->id]) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="p-5 bg-light rounded-3 col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('item_name') is-invalid @enderror" type="text"
                                ...
                                value="{{ $errors->any() ? old('item_name') : $beverage->item_name }}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control @error('current_quantity') is-invalid @enderror" type="text"
                                ...
                                value="{{ $errors->any() ? old('current_quantity') : $beverage->current_quantity }}"
                    ...
                    <div class="row">
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('beverages.index') }}" class="btn btn-outline-dark btn-lg mt-3"><i
