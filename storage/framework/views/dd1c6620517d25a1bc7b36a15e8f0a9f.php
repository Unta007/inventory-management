...
<div class="d-flex">
    <a href="<?php echo e(route('kitchen.edit', ['kitchen' => $kitchen->id])); ?>"
        class="btn btn-custom-yellow btn-sm me-2">
        <i class="bi-pencil-square"></i> Edit
    </a>
    <div>
        <form id="deleteForm" action="<?php echo e(route('kitchens.destroy', ['kitchen' => $kitchen->id])); ?>"
...
<?php /**PATH C:\Users\fauzan\inventory-management\resources\views/kitchen/actions.blade.php ENDPATH**/ ?>