    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto">
                    <a href="<?php echo e(route('employees.index')); ?>" class="nav-link <?php echo e($currentRouteName == 'employees.index' ? 'active' : ''); ?>">Employee</a>
                </li>
            </ul>
            <hr class="d-md-none text-white-50">
...
<?php /**PATH C:\Users\fauzan\InventoryManagement\resources\views/layouts/nav.blade.php ENDPATH**/ ?>